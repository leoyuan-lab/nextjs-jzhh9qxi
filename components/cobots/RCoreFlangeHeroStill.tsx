...
import { R_LITE_ADVISOR_FLANGE_HERO_IMG, ROBOT_IMG_BASE, robotVariantWebpHdFilename } from '@/data/products';

type Props = {
  alt: string;
};

const FR3C_WEBP = `${ROBOT_IMG_BASE}/${robotVariantWebpHdFilename('fr3-c')}`;
